...
describe('callCerebras', () => {
  ...
  it('should throw RateLimitError on 429 response', async () => {
    ...
    await expect(promise).rejects.toThrow('Cerebras rate limit exceeded');
  });
  ...
  it('should include existing content in prompt', async () => {
    const promise = callCerebras('Update function', '', 'output.js', null, [], 'existing code');
  ...
  it('should handle context file read errors gracefully', async () => {
    ...
    const promise = callCerebras('test', '', 'output.js', null, ['/missing.js']);
